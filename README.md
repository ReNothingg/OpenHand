...
В панели настроек включите **«Начало записи»**, выберите номер страницы и перетащите стрелку
за внешним краем листа. Предыдущие страницы остаются пустыми; на выбранной
текст начинается ниже указателя, затем продолжается на следующих страницах.
На развороте можно начать с правой страницы, выбрав 2. Выключение тумблера
возвращает обычную раскладку. Стрелки клавиатуры — 1 мм, Shift — 10 мм,
двойной щелчок — обычный верхний отступ. Указатель не попадает в печать и G-code.
