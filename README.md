...
| --- | --- |
| **Редактор** | Markdown и LaTeX, панель форматирования, формулы, таблицы, списки, цитаты, код, изображения и SVG |
...
| **Плоттер** | Однолинейные шрифты, расчёт траектории, оптимизация холостого хода и G-code |
| **Управление устройством** | Web Serial, GRBL, Marlin и EBB; jog, установка нуля, управление пером, пауза и аварийная остановка |
...
2. Выберите профиль прошивки и скорость порта.
3. Нажмите **«Выбрать USB‑порт»** и подтвердите устройство в системном диалоге.
...
мост к последовательному порту. Он поддерживает те же скорости и сигналы
управления, что macOS-оболочка, системное сохранение экспортов, перетаскивание и
открытие `.gcode`, `.nc` и `.tap`.
