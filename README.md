...
и мастерской. Шаговое перо настраивается короткими относительными шагами до 0,1 мм
на низкой скорости. Кнопки «Сохранить как верхнее / нижнее» запоминают текущую
...
сохранённой пары доступны «Сейчас поднято / опущено».
...
В нативной оболочке версии 4 при активном соединении Esc обрабатывается также
...
ограничений или режима удержания требует проверить затронутую настройку заново.
