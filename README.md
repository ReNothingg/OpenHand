...
документа и мастерской. В блоке «Перо и прижим» можно короткими шагами найти касание,
сохранить его, настроить расстояние подъёма и сразу проверить. «Мягче/Сильнее»
меняет касание на выбранный шаг и проверяет его, сохраняя величину подъёма.
Изменение чисел не двигает плоттер. Подключение, направления осей, ноль листа и
дополнительные параметры находятся на этой же странице.
