...
#ifndef OPENHAND_SWIFT_H
#define OPENHAND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OpenHand",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8OpenHand23LocalAssetSchemeHandler")
@interface LocalAssetSchemeHandler : NSObject <WKURLSchemeHandler>
...
SWIFT_CLASS("_TtC8OpenHand12NativeBridge")
