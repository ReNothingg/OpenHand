...
import { DEFAULT_SETTINGS, normalizeSettings, PAGE_SIZES, STORAGE_KEYS } from './app/config'
...
import { arrangeManualPages, createManualPages, updatePlacementDirective } from './lib/manualLayout'
...
export default function App() {
  ...
  const measureManualBlocks = useCallback((pageIndex, measurements) => {
    setManualLayouts((current) => {
      const next = { ...current }
      let changed = false
      Object.entries(measurements as Record<string, Record<string, any>>).forEach(([blockId, measurement]) => {
