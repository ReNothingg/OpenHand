...
import { normalizeBlockLayout } from '../../lib/manualLayout.js'
...
function findPageAtPoint(clientX, clientY) {
  const pages = [...document.querySelectorAll('.manual-page-content[data-page-index]')]
  ...
  return document.elementsFromPoint(clientX, clientY)
    .find((element) => element.matches?.('.manual-page-content[data-page-index]'))
}
...
export default function ManualPageContent({
  ...
  useLayoutEffect(() => {
    ...
    const measurements = {}
    hostRef.current.querySelectorAll('[data-manual-block]').forEach((element) => {
  ...
  const beginInteraction = (event, block, mode) => {
    ...
    const move = (moveEvent) => {
      ...
      if (mode === 'move') {
        ...
        document.querySelectorAll('.manual-page-content.is-drop-target').forEach((element) => element.classList.remove('is-drop-target'))
