...
import { BUILTIN_GFONT_FAMILIES, BUILTIN_GFONT_OPTIONS } from '../../../plotter/gfont'
...
export default function FontPicker({ fontType, value, plotterFontId, onChange, customFonts = [], onUpload }: {
  ...
  customFonts?: Array<{ id: string; name: string; size: number; plotterFontId: string }>
  ...
  const selected: { name: string; kind: string; family?: string } = fontType === 'plotter'
